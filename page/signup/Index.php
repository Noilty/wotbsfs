...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div id="form-signup" class="grid-content" style="display: none;" align="center">
            <div style="padding: 20px 450px 20px 450px;">
                ...
                <a href="/wotbsfs/page/login/" style="color: #000;">Есть аккаунт?</a>
            </div>
        </div>
        <!-- / Здесь начинается контент -->
    ...
    <script>
        $('#login-to-continue').click(function(){
